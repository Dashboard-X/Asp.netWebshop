...
var OxO3cd4=["ondblclick","navtd","shiftKey","style"]; Window_GetElement(window,OxO3cd4[0x1],true)[OxO3cd4[0x0]]=function (){if(event[OxO3cd4[0x2]]){ alert(element[OxO3cd4[0x3]].cssText) ;} ;}  ;
</script>
