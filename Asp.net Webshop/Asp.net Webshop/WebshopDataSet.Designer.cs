...
namespace Asp.net_Webshop {
    ...
    public partial class WebshopDataSet : global::System.Data.DataSet {
        ...
        public partial class CategoriesDataTable : global::System.Data.TypedTableBase<CategoriesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public CategoriesRow AddCategoriesRow(System.Guid ID, string Name, string Description) {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public ProductsRow AddProductsRow(System.Guid ID, string Name, string Description, decimal Price, bool Enabled, int Quantity, CategoriesRow parentCategoriesRowByFK_Products_Categories) {
...
namespace Asp.net_Webshop.WebshopDataSetTableAdapters {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Categories] ([ID], [Name], [Description]) VALUES (@ID, @Name, " +
                "@Description)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Categories] SET [ID] = @ID, [Name] = @Name, [Description] = @Descri" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["WebshopConnectionString"].ConnectionString;
        }
        ...
        public virtual int Fill(WebshopDataSet.CategoriesDataTable dataTable) {
        ...
        public virtual WebshopDataSet.CategoriesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            WebshopDataSet.CategoriesDataTable dataTable = new WebshopDataSet.CategoriesDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(WebshopDataSet.CategoriesDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, System.Guid Original_ID) {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ID], [Name], [Description], [Price], [Enabled], [Q" +
                "uantity], [CategoryID]) VALUES (@ID, @Name, @Description, @Price, @Enabled, @Qua" +
                "ntity, @CategoryID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ID", global::System.Data.SqlDbType.UniqueIdentifier, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Name", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Products] SET [ID] = @ID, [Name] = @Name, [Description] = @Descript" +
                "ion, [Price] = @Price, [Enabled] = @Enabled, [Quantity] = @Quantity, [CategoryID" +
                "] = @CategoryID WHERE (([ID] = @Original_ID))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ID", global::System.Data.SqlDbType.UniqueIdentifier, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Name", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Description", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Description", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT ID, Name, Description, Price, Enabled, Quantity, CategoryID FROM dbo.Produ" +
                "cts";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        ID, Name, Description, Price, Enabled, Quantity, CategoryID\r\nFROM  " +
                "          Products\r\nWHERE        (ID = @ID)";
        ...
        public virtual WebshopDataSet.ProductsDataTable GetDataByID(System.Guid ID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(System.Guid ID, string Name, string Description, decimal Price, bool Enabled, int Quantity, System.Guid CategoryID) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((System.Guid)(ID));
            if ((Name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[6].Value = ((System.Guid)(CategoryID));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.InsertCommand.Connection.State;
            if (((this.Adapter.InsertCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.InsertCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.Guid ID, string Name, string Description, decimal Price, bool Enabled, int Quantity, System.Guid CategoryID, System.Guid Original_ID) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((System.Guid)(ID));
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((System.Guid)(CategoryID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, decimal Price, bool Enabled, int Quantity, System.Guid CategoryID, System.Guid Original_ID) {
            return this.Update(Original_ID, Name, Description, Price, Enabled, Quantity, CategoryID, Original_ID);
        }
    }
